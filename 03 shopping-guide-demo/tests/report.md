...
| ID | 描述 | 优先级 |
|----|------|-------|
| V4-01 | "帮我点外卖"类非手机场景未识别为 out_of_scope | P2 |
| V4-02 | LLM 链路 P95 延迟偶发 > 6s（GLM-4 排序） | P1 |
| V4-03 | spec_comparison 追问超 3 轮兜底未做强测试 | P2 |

---

## 五、上线结论

**✅ Demo v0.3 通过验收，具备上线条件。**

P0 用例全部通过。主要功能链路（传统搜索 < 5ms、多轮对话、双品牌对比、GLM 排序解释）运行正常。遗留 1 条 P2 意图识别偏差，不影响核心体验。
